...
const sellfun = async (client) => {
    ...
    lastPriceask = lastPriceask - 0.2;
    console.log(getNowFormatDate(), "实际卖出价格:", lastPriceask);
...
const buyfun = async (client) => {
    ...
    lastPrice = lastPrice + 0.2;
    console.log(getNowFormatDate(), "实际买入价格:", lastPrice);
...
rl.question('请输入 apisecret: ', (apisecret) => {
    rl.question('请输入 apikey: ', (apikey) => {
      // 在这里执行您的代码，使用用户输入的 apisecret 和 apikey
